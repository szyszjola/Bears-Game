...
namespace GameProject
{
    ...
    public class Game1 : Game
    {
        ...
        private void SpawnBear()
        {
            ...
            Vector2 randomVector = new Vector2((float)Math.Cos((double)randomAngle) * randomSpeed, (float)Math.Sin((double)randomAngle) * randomSpeed);

            // create new bear
            TeddyBear bear = new TeddyBear(Content, "graphics/teddybear", randomX, randomY, randomVector, null, null);
